...
linker.cmd: package/cfg/uartecho_pem3.xdl
	$(SED) 's"^\"\(package/cfg/uartecho_pem3cfg.cmd\)\"$""\"C:/Users/Ivan/workspace_v6_2/uartecho_CC1310_LAUNCHXL_TI/.config/xconfig_uartecho/\1\""' package/cfg/uartecho_pem3.xdl > $@
